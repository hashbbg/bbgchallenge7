...
bbgchallenge is a friendly game creation challenge, run by hashbbg.com.

The rules will be updated later today; at the moment, if you have suggestions about what the rules should be, fork this and write them up.  Pull request if you have an update to make.


You'll find the bbgchallenge6 rules as a template
---
